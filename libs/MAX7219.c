...
*********************************************************************************************************
*/
#define DATA_PORT     PORTB                           // assume "DATA" is on PORTB
#define DATA_DDR      PORTB
#define DATA_BIT      0x01
#define DATA_0()      (DATA_PORT &= ~DATA_BIT)
#define DATA_1()      (DATA_PORT |=  DATA_BIT)
#define CLK_PORT      PORTB                           // assume "CLK" is on PORTB
#define CLK_DDR       PORTB
#define CLK_BIT       0x04
#define CLK_0()       (CLK_PORT &= ~CLK_BIT)
#define CLK_1()       (CLK_PORT |=  CLK_BIT)
#define LOAD_PORT     PORTB                           // assume "LOAD" is on PORTB 
#define LOAD_DDR      PORTB
